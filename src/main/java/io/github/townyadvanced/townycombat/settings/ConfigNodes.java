...
public enum ConfigNodes {
	...
	UNLOCK_PVP_COMBAT_FOR_REGULAR_PLAYERS(
			...
			"# + cannot participate and are effectively locked out.   + #",
			"# +                                                      + #",
			"# + This Feature Re-Opens Combat to Regular Players:     + #",
			"# + 1. Reduces grinding-time requirement for 'god-sets': + #",
			"# +    Fighters can choose 'lighter' battlefield roles.  + #",
			"# + 2. Reduces grinding-time requirement for potions:    + #",
			"# +    Fewer potions needed per battle.                  + #",
			"# + 3. Reduces training-time requirement:                + #",
			"# +    Potions easier to use.                            + #",
			"############################################################",
			""),
